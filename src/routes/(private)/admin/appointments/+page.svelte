<script>
  ...
  const loadAppointments = async () => {
    ...
    items = querySnapShot.docs.map((v) => {
      return {
        id: v.id,
        ...v.data(),
      };
...
<PageMain {loading}>
  <PageHead
    ...
    subtitle="Update, edit or cancel client appointments here"
  >
    <div slot="action">
          ...
          {#each items as item}
            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <button
                  class="btn btn-square text-white btn-primary btn-sm"
                  on:click={() => goto("/admin/appointments/" + item.id)}
                >
